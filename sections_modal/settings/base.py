...
MEDIA_ROOT = '/var/www/sections_modal_media'
...
STATIC_ROOT = '/var/www/sections_modal_static'

STATIC_URL = '/static/'

NODE_MODULES_ROOT = '/var/www/sections_modal_static'
...
INSTALLED_APPS = [
    ...
    # 'sections_modal.apps.careers',
    'sections_modal.apps.components',
    # 'sections_modal.apps.events',
    # 'sections_modal.apps.faqs',
    # 'sections_modal.apps.footer',
    # 'sections_modal.apps.news',
    # 'sections_modal.apps.partners',
    # 'sections_modal.apps.people',
    'sections_modal.apps.sections',
    'sections_modal.apps.settings',
    'sections_modal.apps.site',
...
ROOT_URLCONF = 'sections_modal.urls'

WSGI_APPLICATION = 'sections_modal.wsgi.application'
...
CACHE_MIDDLEWARE_KEY_PREFIX = 'sections_modal'
